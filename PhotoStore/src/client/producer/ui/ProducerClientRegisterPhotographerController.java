...
public class ProducerClientRegisterPhotographerController implements Initializable {
    ...
    private void handleConfirmButtonAction(MouseEvent event) {
        if (validateForm()) {
            if (ProducerClientRunnable.clientRunnable.registerPhotographer(bEmail.getText(), bPassword.getText(), bName.getText(), bAddress.getText(), bZipcode.getText(), bCity.getText(), bCountry.getText(), bPhone.getText(), bKvk.getText())) {
